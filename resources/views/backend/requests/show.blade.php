...
<x-app-layout>
        ...
        <div class="flex  gap-3 mx-20">
            ...
            <div class="w-8/12  mx-auto sm:px-6 lg:px-8 my-10">
                ...
                <div class="mt-4 text-center">
                    <x-primary-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'add-feedback')">{{
                        __('Send Feedback')
                        }}
    ...
    {{-- modal --}}
    <x-modal name="add-feedback" :show="$errors->dutyFeedback->isNotEmpty()" focusable>
        <form method="post" action="{{ route('feedbacks.store') }}" class="p-6">
            ...
            <input type="hidden" name="request_id" value="{{$myrequest->id}}">
            <div class="mt-6">
                <x-input-label for="duty" value="{{ __('Assign Duty') }}" class="" />

                <x-input-select id="duty" name="user_id" class="mt-1 block w-full">
                    <option selected disabled>Choose Technician</option>
                    @forelse ($techs as $tech)
                    @if ($tech->hasRole('mechanic'))
                ...
                <x-input-error :messages="$errors->dutyFeedback->get('user_id')" class="mt-2" />
            </div>
            <div class="flex gap-4 mt-6">
                <div class="w-full">
                    <x-input-label for="Arrival_date" value="{{ __('Arrival_date') }}" class="" />

                    <x-text-input id="Arrival_date" name="arrival_date" type="date" class="mt-1 block w-full"
                        placeholder="{{ __('Arrival_date') }}" />

                    <x-input-error :messages="$errors->dutyFeedback->get('arrival_date')" class="mt-2" />
                </div>
                <div class="w-full">
                    <x-input-label for="Arrival_time" value="{{ __('Arrival_time') }}" class="" />

                    <x-text-input id="Arrival_time" name="arrival_time" type="time" class="mt-1 block w-full"
                        placeholder="{{ __('Arrival_time') }}" />

                    <x-input-error :messages="$errors->dutyFeedback->get('arrival_time')" class="mt-2" />
                </div>

            </div>
            <div class="mt-6">
                <x-input-label for="description" value="{{ __('Feedback Description ') }}" class="" />

                <x-textarea id="description" name="description" class="mt-1 block w-full"
                    placeholder="{{ __('Feedback Description') }}" />

                <x-input-error :messages="$errors->dutyFeedback->get('description')" class="mt-2" />
            </div>
