            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Technicians</a>
                    </div>
                </li>
                ...
                <div
                    ...
                    <div class="flex flex-col items-center pb-10 mt-3">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{asset('images/user.png')}}"
                            alt="Bonnie image" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{$tech->name}}</h5>
                        <p class="mx-3"><span
                                class="border border-blue-700 rounded px-2 text-sm text-gray-500 dark:text-gray-400">{{$tech->email}}</span>
                        </p>
                        <p class="grid grid-cols-2 gap-3 mx-3">

                            <span
                                class="border border-blue-700 rounded px-2 text-sm text-gray-500 dark:text-gray-400">{{$tech->phone}}</span>
                            <span
                                class="border border-blue-700 rounded px-2 text-sm text-gray-500 dark:text-gray-400">Total
                                Duties:
                                {{$tech->duties->count()}}</span>
                        </p>
