    ...
    <div class="py-12">
        <div class="flex  gap-3 mx-20">
            <div class="w-4/12 mx-auto sm:px-6 lg:px-8 my-10">
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">B Zinaxy</h5>
                        ...
                        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <li class="pt-3 pb-0 sm:pt-4">
                                <div class="flex items-center space-x-9">
                                    <h3 class="text-sm font-medium text-gray-900 truncate dark:text-white">STATUS</h3>
                                    ...
                                    <button disabled type="button"
                                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 inline-flex items-center">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
            ...
            <div class="w-8/12  mx-auto sm:px-6 lg:px-8 my-10">
                ...
                @empty
                <div class="flex items-center space-x-9">
                    <h3 class="text-sm font-medium text-gray-900 truncate dark:text-white">No Feedback Available</h3>
                    <button disabled type="button"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
